...
const userAccessor = require('../accessors/usersAccessor');
...
async function getOrderById(userLogin, orderId) {
...
async function createOrder(userLogin, order) {
    ...
    for (const product of order.products) {
        ...
        let currProduct = await productService.getProductById(
            product.productId,
        );
    ...
    return userAccessor.addOrderToUser(userLogin, orderId);
}
